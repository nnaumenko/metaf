...
TEST(WeatherPhenomena, fromString_obscurations_descriptorMI) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorMI_incorrect) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorPR) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorPR_incorrect) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorBC) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorBC_incorrect) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorDR) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorDR_incorrect) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorBL) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorBL_qualifierVC) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorBL_incorrect) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorFZ) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorFZ_incorrect) {
...
TEST(WeatherPhenomena, fromString_obscurations_BR) {
...
TEST(WeatherPhenomena, fromString_obscurations_FG) {
...
TEST(WeatherPhenomena, fromString_obscurations_FU) {
...
TEST(WeatherPhenomena, fromString_obscurations_VA) {
...
TEST(WeatherPhenomena, fromString_obscurations_DU) {
...
TEST(WeatherPhenomena, fromString_obscurations_SA) {
...
TEST(WeatherPhenomena, fromString_obscurations_HZ) {
...
TEST(WeatherPhenomena, fromString_obscurations_incorrect) {
...
TEST(WeatherPhenomena, fromString_other_descriptorTS) {
...
TEST(WeatherPhenomena, fromString_other_descriptorTS_qualifierVC) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorTS_incorrect) {
...
TEST(WeatherPhenomena, fromString_other_descriptorSH_qualifierVC) {
...
TEST(WeatherPhenomena, fromString_obscurations_descriptorSH_incorrect) {
...
TEST(WeatherPhenomena, fromString_other_PO) {
...
TEST(WeatherPhenomena, fromString_other_SQ) {
...
TEST(WeatherPhenomena, fromString_other_FC) {
...
TEST(WeatherPhenomena, fromString_other_DS) {
...
TEST(WeatherPhenomena, fromString_other_incorrect) {
...
TEST(WeatherPhenomena, fromString_other_SS) {
...
TEST(WeatherPhenomena, fromString_other_DSSS) {
...
TEST(WeatherPhenomena, fromString_other_SSDS) {
...
TEST(WeatherPhenomena, fromString_other_DS_SS_incorrect) {
...
TEST(WeatherPhenomena, fromString_precipitation_IC) {
...
TEST(WeatherPhenomena, fromString_fromString_precipitation_IC_incorrect) {
...
TEST(WeatherPhenomena, fromString_precipitation_DZ) {
...
TEST(WeatherPhenomena, fromString_precipitation_RA) {
...
TEST(WeatherPhenomena, fromString_precipitation_SN) {
...
TEST(WeatherPhenomena, fromString_precipitation_SG) {
...
TEST(WeatherPhenomena, fromString_precipitation_PL) {
...
TEST(WeatherPhenomena, fromString_precipitation_GR) {
...
TEST(WeatherPhenomena, fromString_precipitation_GS) {
...
TEST(WeatherPhenomena, fromString_precipitation_UP) {
...
TEST(WeatherPhenomena, fromString_precipitation_descriptorTS) {
...
TEST(WeatherPhenomena, fromString_precipitation_descriptorSH) {
	...
	const auto wp4 = metaf::WeatherPhenomena::fromString("+SHRA", true);
	ASSERT_TRUE(wp4.has_value());
	EXPECT_EQ(wp4->qualifier(), metaf::WeatherPhenomena::Qualifier::HEAVY);
...
TEST(WeatherPhenomena, fromString_precipitation_descriptorFZ) {
...
TEST(WeatherPhenomena, fromString_precipitation_descriptor_qualifier_incorrect) {
...
TEST(WeatherPhenomena, fromString_precipitation_multiple) {
...
TEST(WeatherPhenomena, fromString_precipitation_multiple_too_long) {
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("DZRASNSGPLGS").has_value());
}

TEST(WeatherPhenomena, fromString_precipitation_multiple_duplicate) {
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("DZRASNDZ").has_value());
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("RARA").has_value());
}

TEST(WeatherPhenomena, fromString_precipitation_multiple_incorrect) {
...
TEST(WeatherPhenomena, fromString_precipitation_multiple_incorrect_descriptor) {
...
TEST(WeatherPhenomena, fromString_precipitation_multiple_qualifier_moderate) {
...
TEST(WeatherPhenomena, fromString_precipitation_multiple_qualifier_light) {
	const auto wp1 = metaf::WeatherPhenomena::fromString("-DZSG", true);
	ASSERT_TRUE(wp1.has_value());
...
TEST(WeatherPhenomena, fromString_precipitation_multiple_qualifier_heavy) {
	const auto wp1 = metaf::WeatherPhenomena::fromString("+DZSG", true);
	ASSERT_TRUE(wp1.has_value());
...
TEST(WeatherPhenomena, fromString_precipitation_multiple_qualifier_recent) {
...
TEST(WeatherPhenomena, fromString_precipitation_descriptor_ts) {
...
TEST(WeatherPhenomena, fromString_precipitation_descriptor_sh) {
...
TEST(WeatherPhenomena, fromString_precipitation_multiple_descriptor_fz) {
...
TEST(WeatherPhenomena, isValidTrueFreezing) {
	...
	EXPECT_TRUE(metaf::WeatherPhenomena::fromString("FZDZ", true)->isValid());
	EXPECT_TRUE(metaf::WeatherPhenomena::fromString("FZUP", true)->isValid());
	EXPECT_TRUE(metaf::WeatherPhenomena::fromString("FZDZ", true)->isValid());
	EXPECT_TRUE(metaf::WeatherPhenomena::fromString("FZRAPL", true)->isValid());
	EXPECT_TRUE(metaf::WeatherPhenomena::fromString("FZDZSG", true)->isValid());
	EXPECT_TRUE(metaf::WeatherPhenomena::fromString("FZRASN", true)->isValid());
	EXPECT_TRUE(metaf::WeatherPhenomena::fromString("FZRASNPL", true)->isValid());
}
...
TEST(WeatherPhenomena, isValidFalseFreezingPrecipitation) {
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("FZSN", true)->isValid());
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("FZPL", true)->isValid());
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("FZSG", true)->isValid());
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("FZGR", true)->isValid());
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("FZGS", true)->isValid());
	EXPECT_FALSE(metaf::WeatherPhenomena::fromString("FZSNPL", true)->isValid());
}